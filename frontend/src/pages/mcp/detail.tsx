...
const MCPDetailPage: React.FC = () => {
  ...
  const [apiGatewayUrl, setApiGatewayUrl] = useState('https://<wntasg-gateway-ip>');
    ...
    try {
      ...
      if (res) {
        ...
        if (res.domains?.[0]) {
          ...
          setApiGatewayUrl('https://<wntasg-gateway-ip>');
        }
      }
    } catch (error) {
                ...
                <Card title={t('mcp.detail.endpointInfo')} bordered style={{ marginTop: 16 }}>
                  <Descriptions column={2}>
                    <Descriptions.Item label={t('mcp.detail.sseEndpoint')}>
                      {`${apiGatewayUrl || 'https://<wntasg-gateway-ip>'}/mcp-servers/${name}/sse`}
                    </Descriptions.Item>
                    <Descriptions.Item label={t('mcp.detail.httpEndpoint')}>
                      {`${apiGatewayUrl || 'https://<wntasg-gateway-ip>'}/mcp-servers/${name}`}
                    </Descriptions.Item>
                  </Descriptions>
                </Card>
              </>
            ...
            children: (
              <>
                ...
                <Card title={t('mcp.detail.connectMcp')} bordered style={{ marginTop: 16 }}>
                  ...
                  {apiGatewayUrl !== 'https://<wntasg-gateway-ip>' && (
                    <div>
